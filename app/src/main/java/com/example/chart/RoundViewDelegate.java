...
public class RoundViewDelegate {
    ...
    public void setWidth(float dpWidth){
        ViewGroup.LayoutParams params = this.view.getLayoutParams();
        params.width = dp2px(dpWidth);
        this.view.post(() -> view.setLayoutParams(params));
    }
    public void setHeight(float dpHeight){
        ViewGroup.LayoutParams params = this.view.getLayoutParams();
        params.height = dp2px(dpHeight);
        this.view.post(() -> this.view.setLayoutParams(params));
    }
